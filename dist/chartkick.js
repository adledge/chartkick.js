 ...
 * https://github.com/adledge/chartkick.js
 * v2.3.6
 * MIT License
 */
...
(function (global, factory) {
  ...
  defaultExport.prototype.renderPolarChart = function renderPolarChart (chart) {
    var options = merge({}, baseOptions);
  ...
  defaultExport$2.prototype.renderComboChart = function renderComboChart (chart) {
      var this$1 = this;
    ...
    this.waitForLoaded(chart, function () {
      ...
      var options = merge(merge(defaultOptions$2, chartOptions), chart.options.library || {});      
      var data = this$1.library.visualization.arrayToDataTable(chart.data);

      this$1.drawChart(chart, "ComboChart", data, options);
    });
  };
  ...
  var formatColumnData = function (data) {
    var parsedData = [];
  ...
  function processCombo(chart) {
    ...
    for (i = 0; i < perfectData.length; i++) {
      if(i === 0) {
        ...
        Object.keys(perfectData[0]).forEach(function (key) {
          keyList.push(key);
        });  
  ...
  var ComboChart = (function (Chart) {
    function ComboChart () {
      Chart.apply(this, arguments);
    }

    if ( Chart ) ComboChart.__proto__ = Chart;
    ComboChart.prototype = Object.create( Chart && Chart.prototype );
    ComboChart.prototype.constructor = ComboChart;

    ComboChart.prototype.__processData = function __processData () {
      return processCombo(this);
    };

    ComboChart.prototype.__chartName = function __chartName () {
      return "ComboChart";
    };
  ...
  var PolarChart = (function (Chart) {
    function PolarChart () {
      Chart.apply(this, arguments);
    }

    if ( Chart ) PolarChart.__proto__ = Chart;
    PolarChart.prototype = Object.create( Chart && Chart.prototype );
    PolarChart.prototype.constructor = PolarChart;

    PolarChart.prototype.__processData = function __processData () {
      return processSeries(this, "polar");
    };

    PolarChart.prototype.__chartName = function __chartName () {
      return "PolarChart";
    };
...
//# sourceMappingURL=chartkick.js.map
